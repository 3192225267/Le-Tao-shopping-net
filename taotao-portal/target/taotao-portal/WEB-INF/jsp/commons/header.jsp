...
<script type="text/javascript" src="/js/style9.js" charset="utf-8"></script>
<!--shortcut start-->
...
<div id="o-header-2013">
	<div class="w" id="header-2013">
		...
		<div id="logo-2013" class="ld"><a href="/" hidefocus="true" clstag="homepage|keycount|home2013|02a"><b></b><img src="${l.pic}" width="180" height="70" ></a></div>
		</c:forEach>
		<%--<ul>--%>
		...
		<div id="my360buy-2013">
			<dl>
			<%--<dt class="ld" id="mine"><s></s>我的<b></b></dt>--%>
				<%--<dt class="fore1" id="mine" ><a href="javascript:login()">我的</a>|<a href="javascript:regist()">注册</a></dt>--%>
				<dt style="width: 55px;"class="fore1" id="mine" clstag="homepage|keycount|home2013|01b"><a href="javascript:login()">登录|</a>&nbsp;<a href="javascript:regist()">注册</a></dt>
				<%--<img src="/img/3.png " width="20px" height="30px" />--%>
				<dd>
