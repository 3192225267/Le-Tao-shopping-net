...
<div class="w w1 header clearfix">
	...
	<div id="logo"><a href="/"><img clstag="clickcart|keycount|xincart|logo" src="${l.pic}" title="返回淘淘商城首页" alt="返回淘淘商城首页"></a></div>
    </c:forEach>
...
<div class="cart-inner">
    <div class="cart-thead clearfix">
        ...
        <div class="column t-inventory">单价</div>
        ...
        <c:forEach items="${cartList}" var="cart">
	        ...
	        <div id="product_11345721" data-bind="rowid:1" class="item item_selected ">
		        <div class="item_form clearfix">
		            ...
		            <div class="cell p-inventory stock-11345721">${ cart.price/100 }</div>
